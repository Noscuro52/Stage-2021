    ...
    return (
        <div class="main">
            ...
            <div class="view view-first">
                <img src={rs} alt="Réseau et sécurité"/>
                    <div class="mask">
                        ...
                        <p>J'ai en 3 années à l'Ephec acquis des compétences en réseau. En passant par le routage, la connectivité, la disponibilité et la sécurité, j'ai
            ...
            <div class="view view-first">
                    ...
                    <div class="mask">                  
                        <h2>Electronique</h2>
                        <p>L'électronique et l'électricité sont des matières que j'ai découvertes et que j'apprécie grandement. Nous sommes constamment
                            entouré d'électroniques et je trouve cela fascinant d'essayer de comprendre ces choses. C'est sans aucun doute un des domaines 
                ...
                <div class="view view-first">
                    ...
                    <div class="mask">         
                        <h2>Programmation</h2>
                        <p>J'ai chaque année au sein de l'Ephec appris plusieurs languages plus ou moins utiles. J'ai commencé par apprendre les 
                ...
                <div class="view view-first">
                    ...
                    <div class="mask">
                        ...
                        <p>Je n'ai pas appris l'IA au sein de l'Ephec elle-même mais pendant mon stage. J'ai réalisé mon stage chez
                            ...
                            capables de traiter un flux vidéo en temps réel.
                        </p>
                    </div>
                </div>
