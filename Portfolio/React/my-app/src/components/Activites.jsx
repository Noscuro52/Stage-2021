            ...
            <div class="view view-first">
                <img src={rn} alt="Formation React Native"/>
                    <div class="mask">
                        ...
                        <p>J'ai réalisé une formation React Native sur le site Open Classroom. Cette formation m'a aidé à
                            développer une application dans la cadre du cours d'intégration. La formation a duré une trentaines d'heures.
                        </p>
                    </div>
            </div>
            <div class="view view-first">
                ...
                <div class="view view-first">
                    ...
                    <div class="mask">         
                        ...
                        <p>J'ai en 2020 et 2021 participé à l'édition du CSC. Un jeu virtuel basé sur la sécurité qui consiste à retrouver des flags
                ...
                <div class="view view-first">
                    ...
                    <div class="mask">
                        <h2>Ralfagram</h2>
                        <p>Nous avons avec un autre étudiant d'IT à la suite du projet de développement web continué ce projet. Le photographe a souhaité
                ...
                <div class="view view-first">
                    ...
                    <div class="mask">
                        <h2>Scouts</h2>
                        <p>Les scouts ont toujours fait partie de ma vie. J'ai commencé les baladins en 2005 à Brussel avant de rejoindre la 22ème BW en
                            2007. Je n'y ai pas bougé depuis, je suis chef louveteaux depuis 3 ans ou j'organise : jeu, journée, week-end, camp pour 40 enfants
                            de 8 à 12 ans.
                        </p>
                    </div>
                </div>
